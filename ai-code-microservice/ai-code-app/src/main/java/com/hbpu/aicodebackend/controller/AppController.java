...
import com.hbpu.aicodebackend.manager.CosManager;
import com.hbpu.aicodebackend.model.dto.app.*;
 ...
 */
@Tag(name = "AppController", description = "应用 控制层。")
@RestController
@RequestMapping("/app")
public class AppController {
     ...
     * @return 更新结果
     */
    @Operation(summary = "更新应用（用户只能更新自己的应用名称）", description = "更新应用（用户只能更新自己的应用名称）")
    @PostMapping("/update")
     ...
     * @return 删除结果
     */
    @Operation(summary = "删除应用（用户只能删除自己的应用）", description = "删除应用（用户只能删除自己的应用）")
    @PostMapping("/delete")
    public BaseResponse<Boolean> deleteApp(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 删除应用时删除 COS 对象（如果存在）
        if (result) {
            cosManager.deleteObject(oldApp.getCover());
        }
     ...
     * @return 应用详情
     */
    @Operation(summary = "根据 id 获取应用详情", description = "根据 id 获取应用详情")
    @GetMapping("/get/vo")
     ...
     * @return 应用列表
     */
    @Operation(summary = "分页获取当前用户创建的应用列表", description = "分页获取当前用户创建的应用列表")
     ...
     */
    @Parameters({
            @Parameter(name = "appId", description = "应用 ID", in = ParameterIn.QUERY, required = true),
            @Parameter(name = "message", description = "用户消息", in = ParameterIn.QUERY, required = true)
    })
