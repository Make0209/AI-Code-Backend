package com.hbpu.aicodebackend.langgraph4j.node;
...
import com.hbpu.aicodebackend.utils.SpringContextUtil;
    ...
    public static AsyncNodeAction<MessagesState<String>> create() {
        return node_async(state -> {
            ...
            try {
                ...
                // 根据原始提示词进行智能路由
                generationType = routingService.routeCodeGenType(context.getOriginalPrompt()).codeGenType();
